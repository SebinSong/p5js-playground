...
class QuadTree {
  constructor (boundary, capcity = 10) {
...
function setup () {
  ...
  for (let i = 0; i < POINT_COUNT; i++) {
    const x = randomGaussian(halfW, halfW / 3)
    const y = randomGaussian(halfH, halfH / 3)
...
function draw () {
  ...
  const hoverRange = new Rectangle(mouse.x - 50, mouse.y - 50, 100, 100)
